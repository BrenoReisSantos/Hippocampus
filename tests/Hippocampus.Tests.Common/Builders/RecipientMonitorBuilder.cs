...
public sealed class RecipientMonitorBuilder : AutoFaker<RecipientMonitor>
{
    ...
    public RecipientMonitorBuilder WithId(RecipientMonitorId recipientMonitorId)
    {
    ...
    public RecipientMonitorBuilder WithRecipientLogs(IEnumerable<RecipientLog> logs)
    {
        RuleFor(monitor => monitor.RecipientLogs, logs);
        return this;
    }
}